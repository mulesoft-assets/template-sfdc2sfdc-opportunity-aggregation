...
As implemented, it gets opportunities from two instances of Salesforce, compares by the email address of the opportunities, and generates a CSV file which shows opportunities in A, opportunities in B, and opportunities in A and B. The report is then emailed to a configured group of email addresses.
